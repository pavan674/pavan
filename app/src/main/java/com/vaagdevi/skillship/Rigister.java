package com.vaagdevi.skillship;
...
import com.vaagdevi.skillship.MainActivity;
import com.vaagdevi.skillship.R;
...
//                       finish();
                ...
                firebaseAuth.createUserWithEmailAndPassword(emailreg,
                        passreg).addOnCompleteListener(Rigister.this, new OnCompleteListener<AuthResult>() {
                    @Override
                        ...
                        if (task.isSuccessful()) {
                            ...
                            FirebaseDatabase.getInstance().getReference(databaseReference.getKey()).child(firebaseAuth.getCurrentUser().getUid()).setValue(reginformation).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    Toast.makeText(Rigister.this, "Hii" + usersname + "...Continue here!", Toast.LENGTH_LONG).show();
...
//Initialize Firebase Auth
                ...
                mAuth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(Rigister.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(Rigister.this, "Please Try Again", Toast.LENGTH_SHORT).show();
                                    //updateUI(null);
                                }
